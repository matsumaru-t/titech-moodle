...
/**
 * Strings for component 'quizaccess_seb', language 'ja', version '3.9'.
 *
...
$string['invalidkeys'] = '設定キーまたはbrowser examキーを有効にできませんでした。あなたが正しい設定ファイルのSafe Exam Browserを使用していることを確認してください。';
