...
/**
 * Strings for component 'block_quickmail', language 'ja', version '3.9'.
 *
...
$string['alternate_availability_course'] = '{$a->courseshortname} 内のすべてのロールを許可する';
...
$string['excluded_recipients_desc'] = 'このメッセージを誰が受信すべきではありませんか?';
...
$string['included_recipients_desc'] = 'このメッセージを誰が受信すべきですか?';
...
$string['invalid_schedule_time_amount'] = 'スケジュールの時間が無効です。';
...
$string['no_alternates'] = 'あなたに代替メールアドレスはありません。新しく作成してください!';
...
$string['picker_style_option_title_help'] = 'あなたがメッセージ作成時に希望する受信者選択インターフェースです。';
...
$string['prepend_class_desc'] = 'メッセージの件名にコース識別情報を追加します。この設定はコース設定で上書きできます。';
...
$string['receipt_help'] = 'デフォルトでメッセージが送信された場合、メッセージ送信者に確認メールを送信します。この設定はコース設定で上書きできます。';
