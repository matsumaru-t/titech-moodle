...
/**
 * Strings for component 'report_customsql', language 'ja', version '3.9'.
 *
...
$string['recordcount'] = 'このレポートは {$a} 行あります。';
...
$string['userhasnothiscapability'] = 'ユーザ「 {$a->username} 」に「 {$a->capability} 」ケイパビリティがありません。リストからこのユーザを削除するか、「 {$a->whocanaccess} 」内の選択肢を変更してください。';
$string['userinvalidinput'] = '無効な入力です。ユーザ名のリストはカンマで区切る必要があります。';
$string['usernotfound'] = 'ユーザ名「 {$a} 」のユーザは存在しません。';
