...
/**
 * Strings for component 'local_moodlemobileapp', language 'ja', version '3.9'.
 *
...
$string['addon.calendar.currentmonth'] = '当月';
...
$string['addon.storagemanager.deletecourse'] = 'すべてのコースデータを開放する';
...
$string['addon.storagemanager.info'] = 'あなたのデバイスに保存されたファイルはアプリの動作を高速化してオフラインでの使用を可能とします。あなたがストレージスペースを空ける必要がある場合、ファイルを安全に解放できます。';
$string['addon.storagemanager.managedownloads'] = 'ダウンロードを管理する';
$string['addon.storagemanager.managestorage'] = 'ストレージを管理する';
$string['addon.storagemanager.storageused'] = 'ファイルストレージ使用:';
...
$string['core.cannotconnecttrouble'] = '私たちにはあなたのサイトへの接続に問題があります。';
$string['core.cannotconnectverify'] = '<strong>アドレスが正しいかどうか確認してください。</strong>';
...
$string['core.confirmgotabroot'] = '本当に {{name}} に戻ってもよろしいですか?';
$string['core.confirmgotabrootdefault'] = '本当に現在のタブの初期ページに移動してもよろしいですか?';
...
$string['core.course.activitydisabled'] = 'あなたの組織はこの活動をモバイルアプリで無効にしています。';
$string['core.course.activitynotyetviewableremoteaddon'] = 'あなたの組織はまだサポートされていないプラグインをインストールしました。';
$string['core.course.activitynotyetviewablesiteupgradeneeded'] = 'あなたの組織のMoodleインストレーションはアップデートする必要があります。';
$string['core.course.allsections'] = '全てのセクション';
$string['core.course.aria:sectionprogress'] = 'セクション進捗:';
$string['core.course.askadmintosupport'] = 'あなたがこの活動をMoodleモバイルアプリで使用したい旨、サイト管理者に連絡して伝えてください。';
...
$string['core.course.confirmdeletemodulefiles'] = '本当にこれらのファイルを削除してもよろしいですか?';
$string['core.course.confirmdeletestoreddata'] = '本当に保存データを削除してもよろしいですか?';
...
$string['core.course.couldnotloadsectioncontent'] = 'セクションコンテンツを読み込めませんでした。後ほど再度お試しください。';
$string['core.course.couldnotloadsections'] = 'セクションを読み込めませんでした。後ほど再度お試しください。';
...
$string['core.login.changepasswordhelp'] = 'あなたのパスワードの変更に問題が生じた場合、サイト管理者にご連絡ください。「サイト管理者」はあなたの学校/大学/会社または学習組織でMoodleを管理する人のことです。連絡先がわからない場合、先生/トレーナーにご連絡ください。';
...
$string['core.login.localmobileunexpectedresponse'] = 'Moodleモバイル追加機能チェックは予期しないレスポンスを返しました。あなたは標準のモバイルサービスで認証されます。';
...
$string['core.login.reconnectdescription'] = 'あなたの認証トークンが無効または有効期限が切れています。あなたはサイトに再度接続する必要があります。';
...
$string['core.mainmenu.changesite'] = 'サイトを変更する';
...
$string['core.settings.deletesitefiles'] = '本当にダウンロードしたファイルおよびキャッシュデータを「 {{sitename}} 」から削除しますか? あなたはアプリのオフラインモードを使用できないようになります。';
$string['core.settings.deletesitefilestitle'] = 'サイトファイルを削除する';
...
$string['core.settings.errordeletesitefiles'] = 'サイトファイルの削除中にエラーが発生しました。';
...
$string['core.settings.spaceusagehelp'] = 'サイトの保存情報を削除した場合、サイトのオフラインデータすべてが削除されます。あなたはこの情報によりオフライン時にアプリを使用できます。';
...
$string['core.toggledelete'] = '削除ボタンを繰り替える';
