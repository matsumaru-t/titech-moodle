...
/**
 * Strings for component 'theme_adaptable', language 'ja', version '3.9'.
 *
...
$string['alertcolorsheadingdesc'] = '色およびアイコンを設定します。';
...
$string['alerthiddencoursetext-1'] = 'このコースは非表示にされているため、学生からはアクセスできません。';
$string['alerthiddencoursetext-2'] = 'ここをクリックして設定を更新する';
...
$string['categoryheaderssettingsheading'] = '1つまたはそれ以上のトップレベルカテゴリおよび下位カテゴリのヘッダを変更します。';
...
$string['coursesectionactivityfurtherinformation'] = 'コースページ詳細情報';
$string['coursesectionactivityfurtherinformationassign'] = '課題情報を表示する';
$string['coursesectionactivityfurtherinformationassigndesc'] = '締切日、提出ステータス等の課題情報を表示します。教師、管理者には提出数が表示されます。';
$string['coursesectionactivityfurtherinformationchoice'] = '投票情報を表示する';
$string['coursesectionactivityfurtherinformationchoicedesc'] = '締切日、提出ステータス等の投票情報を表示します。教師、管理者には提出数が表示されます。';
$string['coursesectionactivityfurtherinformationdata'] = 'データベース情報を表示する';
$string['coursesectionactivityfurtherinformationdatadesc'] = '締切日、提出ステータス等のデータ情報を表示します。教師、管理者には提出数が表示されます。';
$string['coursesectionactivityfurtherinformationfeedback'] = 'フィードバック情報を表示する';
$string['coursesectionactivityfurtherinformationfeedbackdesc'] = '締切日、提出ステータス等のフィードバック情報を表示します。教師、管理者には提出数が表示されます。';
$string['coursesectionactivityfurtherinformationlesson'] = 'レッスン情報を表示する';
$string['coursesectionactivityfurtherinformationlessondesc'] = '締切日、提出ステータス等のレッスン情報を表示します。教師、管理者には提出数が表示されます。';
$string['coursesectionactivityfurtherinformationquiz'] = '小テスト情報を表示する';
$string['coursesectionactivityfurtherinformationquizdesc'] = '締切日、提出ステータス等の小テスト情報を表示します。教師、管理者には提出数が表示されます。';
...
$string['coursesectionactivityuseadaptableicons'] = 'Adaptableアイコンセットを使用する';
$string['coursesectionactivityuseadaptableiconsdesc'] = 'Adaptableアイコンを使用する場合、これを有効にしてください。無効にした場合、デフォルトのMoodleアイコンを使用するには「adaptable/pix_plugins」および「adaptable/pix_core/f」ディレクトリを削除してください。';
...
$string['customcssjssettings'] = 'カスタムCSS & JS';
...
$string['enablemyhomedesc'] = '{$a} へのリンクを表示します。';
...
$string['feedbackavailable'] = 'フィードバック利用可';
...
$string['frontpagealertsettings'] = '警告ボックス';
...
$string['frontpagetickersettings'] = 'フロントページティッカ';
...
$string['genericsettingsdescription'] = 'ここであなたはテーマに独自CSSおよびJavaScriptコードを追加する様々な設定を確認できます。';
$string['genericsettingsheading'] = 'あなた独自の修正を適用する';
...
$string['invalidcategorycss'] = 'カテゴリ「 {$a->topcatname} 」(ID: {$a->topcatid} のカテゴリカスタムCSSが無効です:  {$a->css})';
$string['invalidcategorygeneratedcss'] = '無効なカテゴリカスタム生成CSS: {$a->css}';
...
$string['mobileslidebartabbkcolor'] = 'サイドバータブ背景色';
$string['mobileslidebartabbkcolordesc'] = 'モバイルデバイスのサイドバー背景色を設定します (折りたたみ)。';
$string['mobileslidebartabiconcolor'] = 'サイドバータブアイコン色';
$string['mobileslidebartabiconcolordesc'] = 'モバイルデバイスのサイドバーアイコン色を設定します (折りたたみ)。';
...
$string['navbarmenusettings'] = 'ナビゲーションバーカスタムメニュー';
$string['navbarmenusettingsdesc'] = 'あなたがナビゲーションバーにメニューを追加できるようにします。';
$string['navbarmenusettingsheading'] = 'ナビゲーションバーのメニューをカスタマイズします。<a href="./../theme/adaptable/pix/layout.png" target="_blank">ここ</a>でレイアウトを確認してください。';
...
$string['privacy:metadata'] = 'Adaptableはいかなる個人ユーザデータも保存しません。';
...
$string['showyourprogress'] = '「あなたの進捗」ラベルを表示する';
$string['showyourprogressdesc'] = 'コースコンテンツ上部に「あなたの進捗」ラベルを表示/非表示にします。このラベルは情報を提供する目的のみに使用されるため非表示にできます。';
$string['side-post1'] = 'フッタのサイドバー';
$string['sidebaricon'] = 'サイドバーを表示/非表示にする';
$string['sidebarnotlogged'] = 'ログアウト時にサイドバーを表示する';
$string['sidebarnotloggeddesc'] = 'ユーザがログアウトした場合にブロックサイドバーを表示します。';
...
$string['slideroption2snippet'] = '<p>スライダキャプションのサンプルHTMLです:</p> <pre> <div class="span6 col-sm-6"> <h3>Hand-crafted</h3> <h4>Moodleコミュニティのピクセルおよびコード</h4> <a href="#" class="submit">私たちのテーマをお気に入りにしてください!</a> </pre>';
...
$string['socialwall'] = 'ソーシャルウォール';
$string['socialwallactionlinkcolor'] = 'アクションリンク色';
$string['socialwallactionlinkcolordesc'] = 'ソーシャルウォールのアクションリンクの色です。';
$string['socialwallactionlinkhovercolor'] = 'アクションリンクホバー色';
$string['socialwallactionlinkhovercolordesc'] = 'ソーシャルウォールでのホバー時のアクションリンクの色です。';
$string['socialwallbackgroundcolor'] = '背景色';
$string['socialwallbackgroundcolordesc'] = 'ソーシャルウォールコースの背景色です。';
$string['socialwallbordercolor'] = '枠線色';
$string['socialwallbordercolordesc'] = 'ソーシャルウォールセクションの枠線色です。';
$string['socialwallbordertopstyle'] = '枠線スタイル';
$string['socialwallbordertopstyledesc'] = 'ソーシャルウォールセクションの枠線スタイルです。';
$string['socialwallborderwidth'] = '枠線幅';
$string['socialwallborderwidthdesc'] = 'ソーシャルウォールセクションの枠線幅です。';
$string['socialwalldesc'] = '<a href="https://moodle.org/plugins/format_socialwall">ソーシャルウォールコースフォーマット</a>のアピアランスをカスタマイズします (あなたのサイトで使用している場合)。';
$string['socialwallheading'] = 'ソーシャルウォール設定';
$string['socialwallsectionradius'] = '枠線レディアス';
$string['socialwallsectionradiusdesc'] = 'ソーシャルウォールセクションの枠線レディアスです。';
$string['standard'] = '標準';
...
$string['warning'] = '警告';
$string['wide'] = 'フルスクリーン';
$string['xofyanswered'] = '{$a->completed} / {$a->participants} 解答';
$string['xofyattempted'] = '{$a->completed} / {$a->participants} 受験';
$string['xofycontributed'] = '{$a->completed} / {$a->participants} 投稿';
$string['xofysubmitted'] = '{$a->completed} / {$a->participants} 送信';
$string['xungraded'] = '{$a} 未評定';
