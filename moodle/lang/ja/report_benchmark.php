...
/**
 * Strings for component 'report_benchmark', language 'ja', version '3.9'.
 *
...
$string['slowwebsolution'] = '<ul><li><a href="/admin/purgecaches.php" target="_blank">Moodleキャッシュをパージしてください</a>。</li></ul>';
